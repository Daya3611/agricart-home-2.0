...
function page() {
  return (
    <div className="p-8 bg-gradient-to-r from-blue-50 via-green-50 to-yellow-50 mt-[50px]">
      <div className="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-3xl">
        ...
        <h1 className="text-4xl font-extrabold text-gray-900 mb-8 border-b-4 border-teal-500 pb-2">Objective</h1>
        ...
        <table className="w-full mb-8 border-separate border-spacing-6">
          <tbody>
            <tr>
              ...
              <td className="w-full md:w-1/3">
                <img src="./img/about/metho-img2.png" alt="Methodology 2" className="w-full h-auto rounded-lg shadow-md transition-transform duration-300 hover:scale-105" />
              </td>
            </tr>
