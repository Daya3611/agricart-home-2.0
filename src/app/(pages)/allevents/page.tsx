    ...
    <section className="container mx-auto px-4 py-8 mt-10">
      ...
      >
        {events.map((event, index) => (
          <motion.div
            key={index}
            className="relative cursor-pointer border-[10px] rounded-3xl hover:border-green-600 hover:bg-green-600 border-white shadow-lg shadow-gray-400 transition-all duration-300"
            variants={item}
            whileHover={{ rotate: 4 }}
          >
            <Image
